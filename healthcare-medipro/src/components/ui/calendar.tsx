  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: "text-input-label w-8 font-normal text-[0.8rem]",
        ...
        day: "p-0 size-8 text-sm flex-1 flex items-center justify-center has-[button]:hover:!bg-accent rounded-md has-[button]:hover:aria-selected:!bg-primary has-[button]:hover:text-accent-foreground has-[button]:hover:aria-selected:text-white-200",
        day_button: cn(
        ...
        selected:
          "bg-primary text-white-200 hover:!bg-primary hover:text-white-200 focus:bg-primary focus:text-white-200",
        today: "bg-accent text-accent-foreground",
        outside:
          "day-outside text-input-label opacity-50 aria-selected:bg-accent/50 aria-selected:text-input-label aria-selected:opacity-30",
